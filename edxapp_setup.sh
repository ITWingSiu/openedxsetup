...
#Print the setup version
echo "Setup Version :" $OPENEDX_RELEASE 
...
##
cd /var/tmp/configuration/playbooks && sudo -E ansible-playbook -c local ./edx-east/edxapp.yml -i "localhost," $EXTRA_VARS
